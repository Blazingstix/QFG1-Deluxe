...
(instance egoHead of View
	(properties
		y 79
		x 160
		view vEgoHeroPose ;CI: NOTE: this gets initialized to the proper avatar's head during the room init.
		loop 1
	)
)
		...
		(cond 
			...
			(
				(or
					(Said 'look/guard')
					(MouseClaimed self event emRIGHT_BUTTON)
					(MouseClaimed onRGuard event emRIGHT_BUTTON)
				)
				(CenterPrint 141 5)
		...
		(cond 
			...
			(
				(or
					...
					(MouseClaimed self event emRIGHT_BUTTON)
					(MouseClaimed onTable2 event emRIGHT_BUTTON)
					(MouseClaimed onTable3 event emRIGHT_BUTTON)
				)
				(CenterPrint 141 6)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(baron setCel: 1)
				(egoHead hide:)
				(TalkObjMessages baronTalk 141 13 141 14 141 15)
			...
			(2
				(egoHead hide:)
				(baron setCel: 0)
				(TalkObjMessages baronTalk 141 16)
				;"Barnard."
			)
			(3
				(egoHead show:)
				(son setCel: 1)
				(TalkObjMessages sonTalk 141 17)
			...
			(4
				(if (Btst DEFEATED_KOBOLD)
					(egoHead hide:)
					(baron setCel: 2)
					(TalkObjMessages baronTalk 141 18 141 19)
			...
			(7
				(egoHead show:)
				(son setCel: 0)
				(TalkObjMessages sonTalk 141 20)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(egoHead hide:)
				(baron setCel: 2)
				(TalkObjMessages baronTalk 141 21 141 22)
			...
			(6
				(egoHead hide:)
				(TalkObjMessages baronTalk 141 26)
	...
	(method (handleEvent event)
		...
		(cond 
			...
			((Said 'chat,affirmative,please')
				(TalkObjMessages baronTalk 141 27)
				;"Just ask about anything you wish to know."
				)
			((Said 'n,nap,rest,done')
				(HandsOff)
				(TalkObjMessages baronTalk 141 28)
			...
			((Said 'ask>')
				...
				(cond 
					((Said '//curse')
						(TalkObjMessages baronTalk 141 29 141 30 141 31)
					...
					((Said '//prediction,countercurse')
						(TalkObjMessages baronTalk 141 32 141 33)
						;"The prophecy stated,
					...
					((Said '//ogress,baba,baba,baba')
						(TalkObjMessages baronTalk 141 34)
					...
					((Said '//magic,wizard,zara,erasmus,erana')
						(TalkObjMessages baronTalk 141 35)
					...
					((Said '//hill,zauberberg')
						(TalkObjMessages baronTalk 141 36)
					...
					((Said '//elsa,girl,daughter')
						(TalkObjMessages baronTalk 141 37 141 38 141 39)
					...
					((Said '//baroness,wife')
						(TalkObjMessages baronTalk 141 40 141 41)
						;"My wife has been gone for many years."
						;"She died giving birth to Elsa, my daughter."
						)
					((Said '//bandit')
						(TalkObjMessages baronTalk 141 42 141 43 141 44 141 45)
					...
					((Said '//leader')
						(TalkObjMessages baronTalk 141 48 141 49)
					...
					((Said '//warlock')
						(TalkObjMessages baronTalk 141 50)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(TalkObjMessages baronTalk 141 60)
