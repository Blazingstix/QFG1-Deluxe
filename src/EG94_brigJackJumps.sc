...
(instance jackJumps of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				((ScriptID 94 15) cycleSpeed: 1 setCycle: CycleTo 1 cdFORWARD self)
				((ScriptID 94 16) play:)
			)
			(5
			...
			(6
				((ScriptID 94 15) cycleSpeed: 2 setCycle: CycleTo 1 cdFORWARD self)
				((ScriptID 94 16) play:)
			)
			(7
				((ScriptID 94 15) setCycle: EndLoop self)
			...
			(8
				((ScriptID 94 15) cycleSpeed: 3 setCycle: CycleTo 1 cdFORWARD self)
				((ScriptID 94 16) play:)
			)
			(9
				((ScriptID 94 15) setCycle: EndLoop self)
			...
			(10
				((ScriptID 94 15) cycleSpeed: 4 setCycle: CycleTo 1 cdFORWARD self)
				((ScriptID 94 16) play:)
			)
			(11
				((ScriptID 94 15) setCycle: EndLoop self)
			...
			(12
				((ScriptID 94 15) cycleSpeed: 5 setCycle: CycleTo 1 cdFORWARD self)
				((ScriptID 94 16) play:)
			)
			(13
				((ScriptID 94 15) setCycle: EndLoop self)
