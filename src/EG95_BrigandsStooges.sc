		...
		(switch (= state newState)
			...
			(1
				(if ((ScriptID 95 0) notify: 16)
					(EgoDead DIE_RETRY DIE_ENDGAME_STOOGES1 158 1
			...
			(3
				(if ((ScriptID 95 0) notify: 16)
					...
					(EgoDead DIE_RETRY DIE_ENDGAME_STOOGES2 158 2
						#icon (GetEgoViewNumber vEgoDefeatedMagic) 0 9
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(ego
					view: (GetEgoViewNumber vEgoSwing)
					setLoop: 0
					setCel: 0
					setPri: 7
					illegalBits: 0
			...
			(6
				...
				(ego
					view: (GetEgoViewNumber vEgoStanding)
					loop: 1
					setCel: 0
			...
			(7
				(ego
					...
					posn: 212 100
					cycleSpeed: 3
					setCycle: CycleTo 7 cdFORWARD self
				)
