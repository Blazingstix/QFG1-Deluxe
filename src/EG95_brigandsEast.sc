...
(instance pushCan of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(ego view: (GetEgoViewNumber vEgoStanding) setLoop: 1 setCel: 0)
		...
		(switch (= state newState)
			...
			(2
				(if (ego inRect: 50 108 230 124)
					(HandsOff)
					(ego loop: 0)
					((ScriptID 95 12) setPri: RELEASE setMotion: MoveTo 224 113)
			...
			(5
				(EgoDead DIE_RETRY DIE_ENDGAME_BRIGANDS_EAST 159 1
