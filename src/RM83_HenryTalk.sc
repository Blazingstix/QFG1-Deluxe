	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 144 0)
				;"E's me friend, 'e and Fenrus.  Powerful wizard 'e is."
			)
			(1
				(TalkObjMessages (ScriptID 83 1) 144 1)
				;"I 'ere 'is 'ouse is sumthin' to see up north."
			)
			(2
				(TalkObjMessages (ScriptID 83 1) 144 2)
			...
			(3
				(TalkObjMessages (ScriptID 83 1) 144 3)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 144 4)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 144 5)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 144 6)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 144 9)
