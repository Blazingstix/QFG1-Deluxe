	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 0)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 1)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 2)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 3)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 4)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 9)
				;"The spells wot I nose is pretty simple maybe, but I like 'em."
			)
			(1
				(TalkObjMessages (ScriptID 83 1) 145 10)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 11)
				;"I nose sum magic.  Erasmus the wizard tot me sum spells."
			)
			(1
				(TalkObjMessages (ScriptID 83 1) 145 12)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				((ScriptID 83 1) caller: self)
				(HandsOff)
				(TalkObjMessages (ScriptID 83 1) 145 13)
				;"This 'ere's wot's called the Flying Falls."
			)
			(1
				(TalkObjMessages (ScriptID 83 1) 145 14)
