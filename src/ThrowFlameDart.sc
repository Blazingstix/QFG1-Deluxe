...
(procedure (AnimateThrowingFlameDart target &tmp temp0 temp1 newAct_2)
	(LoadMany RES_SOUND (GetSongNumber 33) (GetSongNumber 45))
...
;	CI: This doit method was unable to be automatically decompiled by the version of SCICompanion I used. 
;		It was manually decompiled above.
;	(method (doit &tmp tmpHitTarget)
;		(asm
;			pushi    1
;			lsl      whoTarget
...
;			lsl      targetX
;			lsl      targetY
;			callk    GetDistance,  8		;(GetDistance (client x?) (client y?) targetX targetY)
;			push    
;			pushi    25
;			pushi    4
;			dup     
...
;			lsl      targetX
;			lsl      targetY
;			callk    GetDistance,  8		;(GetDistance (ego x?) (ego y?) targetX targetY)
;			add     
;			gt?     
;			bnt      code_02b3
;code_02a2:
...
;	)
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(2
				(if isHitTarget
					(hitSound stop: number: (GetSongNumber 45) play:)
