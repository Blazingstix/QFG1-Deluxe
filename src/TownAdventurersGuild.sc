...
(instance rm311 of Room
	...
	(method (init)
		(Load RES_VIEW vAdventurerGuild)
		(Load RES_VIEW vWolfgang)
		(super init:)
...
(instance onDragon of RFeature
	...
	(method (handleEvent event)
		(cond 
			...
			((MouseClaimed onDragon event emRIGHT_BUTTON) (LookDragon))
		)
	)
)
...
(instance onCheetaur of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onCheetaur event emRIGHT_BUTTON) (LookCheetaur))
		)
	)
)
...
(instance onTroll of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onTroll event emRIGHT_BUTTON) (LookTroll))
		)
	)
)
...
(instance onGryphon of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onGryphon event emRIGHT_BUTTON) (LookGryphon))
		)
	)
)
...
(instance onAntwerp of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onAntwerp event emRIGHT_BUTTON) (LookAntwerp))
		)
	)
)
...
(instance onSaurus of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onSaurus event emRIGHT_BUTTON) (LookSaurus))
		)
	)
)
...
(instance onMoose of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onMoose event emRIGHT_BUTTON) (LookMoose))
		)
	)
)
...
(instance onGuildMaster of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onGuildMaster event emRIGHT_BUTTON) (LookMaster))
		)
	)
)
...
(instance onFireplace of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onFireplace event emRIGHT_BUTTON) (LookFireplace))
		)
	)
)
...
(instance onLog of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onLog event emRIGHT_BUTTON) (Logbook))
		)
	)
)
...
(instance onQuestBoard of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onQuestBoard event emRIGHT_BUTTON) (ReadNoticeBoard))
		)
	)
)
