...
(instance proprietor of Actor
	...
	(method (handleEvent event)
		(switch (event type?)
			(mouseDown
				(if (MouseClaimed self event emRIGHT_BUTTON)
					(HighPrint 322 6)
			...
			(evSAID
				(cond 
					...
					((or (Said 'chat>') (Said 'ask>'))
						(cond 
							((and (not proprietorAttention) nearCounter) (proprietorScript cue:) (event claimed: 1))
							((not nearCounter)
								(HighPrint 322 16)
								;Either the shopkeeper can't hear you or he's ignoring you.  Try striding right up to the counter.
								(event claimed: TRUE))
...
(instance onKeg4 of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onKeg4 event emRIGHT_BUTTON)
				(HighPrint 322 7)
				;The barrels appear to be filled with something and look rather heavy.
				)
		)
...
(instance onStove of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onStove event emRIGHT_BUTTON)
				(HighPrint 322 5)
				;The stove is burning merrily away, making the shop seem almost too warm.
				)
		)
...
(instance onFlask of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onFlask event emRIGHT_BUTTON)
				(HighPrint 322 45)
...
(instance onTeaPot of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onTeaPot event emRIGHT_BUTTON)
				(HighPrint 322 47)
...
(instance onEggs of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onEggs event emRIGHT_BUTTON)
				(HighPrint 322 48)
				;Pickled Saurus eggs.
				)
		)
...
(instance onLinen of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onLinen event emRIGHT_BUTTON)
				(HighPrint 322 49)
...
(instance onFlour of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onFlour event emRIGHT_BUTTON)
				(HighPrint 322 50)
				;Bags of flour.
				)
		)
...
(instance onPigsFeet of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onPigsFeet event emRIGHT_BUTTON)
				(HighPrint 322 51)
				;Pickled pigs feet.
				)
		)
...
(instance onBeets of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onBeets event emRIGHT_BUTTON)
				(HighPrint 322 52)
...
(instance onTea2 of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onTea2 event emRIGHT_BUTTON)
				(HighPrint 322 53)
...
(instance onSalt of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onSalt event emRIGHT_BUTTON)
				(HighPrint 322 54)
...
(instance onSugar of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onSugar event emRIGHT_BUTTON)
				(HighPrint 322 55)
...
(instance onSaltPork of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onSaltPork event emRIGHT_BUTTON)
				(HighPrint 322 56)
				;Salted, dried Saurus.
				)
		)
...
(instance onPepper of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onPepper event emRIGHT_BUTTON)
				(HighPrint 322 57)
...
(instance onHoney of RFeature
	...
	(method (handleEvent event)
		(cond 
			((super handleEvent: event))
			((MouseClaimed onHoney event emRIGHT_BUTTON)
				(HighPrint 322 58)
