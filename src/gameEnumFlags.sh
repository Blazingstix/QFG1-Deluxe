...
(enum 110
	...
	SIGNED_LOGBOOK 				;127
	SLEPT_AT_INN 				;128
	SAVE_ENABLED 				;129	; game saving is disabled in certain rooms, like during battles.
	...
	HAVE_KOBOLD_MUSHROOMS 		;148	; replaced flag 174 in 1.200
	...
	BEAR_FRIENDLY 				;160
	BEAR_GONE 					;161
	ENTERROOM_WEST				;162 CI: added by me, for Target Range (and Brigand Gate) retries
	ENTERROOM_EAST				;163 CI: added by me, for Target Range (and Brigand Gate) retries.
	GHOSTS_ATTACK 				;164
	OBTAINED_TOADSTOOLS 		;165
	KOBOLD_HAS_SEEN_MAGIC		;166 (Has the Kobold witness Ego's use of magic?
	MET_BEAR 					;167
	PROTECTED_UNGUENT 			;168
	DEFEATED_BEAR 				;169
	SAVED_BARNARD 				;170
	MET_BONEHEAD 				;171
	BABAYAGA_HUT_OPEN 			;172
	BABAYAGA_FLY_AWAY 			;173
	HERO_SEEN_REVERSAL		 	;174	; originally used for checking if player has Kobold Toadstools
	...
	EXITED_TOWN_2 				;199
	DIE_RETRY_INPROGRESS		;200 ;CI: Added by me -- Indicates we're in the middle of resetting the scene after a Death. Used when a Retry takes us to a different room.
	DISPEL_LEARNED_RECIPE 		;201
	STAG_PRESENT 				;202
	STAG_HURT 					;203
	ANTWERP_SKY 				;204
	HERO_OVERENCUMBERED 		;205
	ANTWERP_SPLIT 				;206
	MET_FOX 					;207
	OBTAINED_GEM 				;208
	...
	FLAG_233					;MONSTER_HIT?? unsure; related to combat
...
; Events 256-260 are related to Yorick's maze
	...
	HAVE_FAIRY_MUSHROOMS 		;279
	KOBOLD_BOUNCING_FLAMEDART	;280 (set in Kobold Flame Dart)
	KOBOLD_REVERSAL_ACTIVE		;281 
	KOBOLD_CHEST_EXPLODED 		;282
	KOBOLD_HERO_CAST_FLAMEDART	;283 (cleared in Kobold Flame Dart)
	UNUSED_284		;----------- 
	UNUSED_285		;----------- 
	UNUSED_286		;----------- 
	UNUSED_287		;----------- 
	...
	MET_GREEN_MEEP 				;305
	SAW_BLACKBIRD				;306 	;CI: added by me, to flag in the save character... maybe we can use this in future games.
	UNUSED_307
	UNUSED_308
	UNUSED_309
	UNUSED_310
