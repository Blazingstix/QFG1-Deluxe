...
(define ctlBLACK			         $0001)	//1
(define ctlNAVY			             $0002)	//2
(define ctlGREEN			         $0004) //4
(define ctlTEAL			             $0008) //8
(define ctlMAROON		             $0010) //16
(define ctlPURPLE		             $0020) //32
(define ctlBROWN			         $0040) //64
(define ctlSILVER		             $0080) //128
(define ctlGREY			             $0100) //256
(define ctlBLUE			             $0200) //512
(define ctlLIME			             $0400) //1024
(define ctlCYAN			             $0800) //2048
(define ctlRED			             $1000) //4096
(define ctlFUCHSIA		             $2000) //8192
(define ctlYELLOW		             $4000) //16384
(define ctlWHITE			         $8000) //32768
/*************************************************************************
 * DrawPic options 
 *************************************************************************/
