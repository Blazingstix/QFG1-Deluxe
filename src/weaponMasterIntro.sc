...
(instance startFight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				((ScriptID 221 0) cycleSpeed: 2 setCycle: CycleTo 2 cdFORWARD)
				(= cycles 10)
			)
			(5
				(HighPrint 222 0)
				;"I salute you!"
				(ego
					view: (GetEgoViewNumber vEgoTalkWeaponMaster)
					setLoop: (if ((ScriptID 221 0) fightLeft?) 0 else 1)
